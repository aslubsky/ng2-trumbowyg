"use strict";
var TrumbowygCodemirrorPlugin = (function () {
    ...
    TrumbowygCodemirrorPlugin.init = function (editor, lang) {
        ...
        editor.plugins.codemirror = {
            init: function (t) {
                ...
                //             if (t.$codeMirror) {
                //                 t.$codeMirrorEl.css('display', 'none');
                //             }
                //             t.$ta.attr('tabindex', -1);
                //         } else {
                //             if (t.$codeMirror) {
                //                 t.$codeMirrorEl.css('display', 'block');
                ...
                //             matchBrackets: true
                //         });
                //         t.$codeMirrorEl = t.$box.find('.CodeMirror');
                //         t.$codeMirrorEl.css('display', 'none');
...
exports.TrumbowygCodemirrorPlugin = TrumbowygCodemirrorPlugin;
